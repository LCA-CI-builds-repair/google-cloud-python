...
# you may not use this file except in # Private Cloud Attributes
# - `name`: The name of the private cloud.
# - `nodeTypeId`: The node type ID of the management cluster.
# - `description`: User-provided description for this private cloud.
# - `hcx`: HCX appliance (Output only).
# - `nsx`: NSX appliance (Output only).ce with the License.
